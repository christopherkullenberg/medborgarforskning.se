...
class Project(models.Model):
    ...
    '''Note: I set null=True here just to be able to import the EU-projects. -CK'''
    date_created = models.DateTimeField(_('The date the Project created'), auto_now=True, null=True) ## maps to PPSR PMM  projectDateCreated

    date_updated = models.DateTimeField(_('Last date the Project was updated'), auto_now=True, null=True) ## maps to PPSR PMM  projectLastUpdatedDate
    ...
    url = models.FileField(max_length=500, blank=True, verbose_name="Project url") ## maps to PPSR PMM projectUrl
